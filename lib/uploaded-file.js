...
module.exports = class UploadedFile {
  ...
  constructor(audioEvent) {
    ...
    this.durationMs  = null; // in milliseconds
    ...
    this.hasVideo    = null;
    this.videoFormat = null; // video stream codec name
  ...
  setValidated(validData) {
    ...
    this.valid = (this.hasAudio || this.hasVideo) ? true : false;
  }
  ...
  toJSON() {
    return JSON.stringify({
      ...
      size: this.size,
      // audio fields
      hasAudio: this.hasAudio ? true : false,
      ...
      layout: this.layout,
      // video fields
      hasVideo: this.hasVideo ? true : false,
